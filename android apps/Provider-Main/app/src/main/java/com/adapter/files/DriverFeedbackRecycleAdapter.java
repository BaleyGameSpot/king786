...
public class DriverFeedbackRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            //viewHolder.dateTxt.setText(generalFunc.convertNumberWithRTL(generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(item.get("tDateOrig"), Utils.OriginalDateFormate, DateTimeUtils.DateFormat))));
            viewHolder.dateTxt.setText(generalFunc.convertNumberWithRTL(item.get("tDisplayDateTime")));
