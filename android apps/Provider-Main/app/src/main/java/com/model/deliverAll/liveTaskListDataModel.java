...
public class liveTaskListDataModel implements Serializable {
    ...
    public String getUserPPicName() {
        return UserPPicName;
    }

    public void setUserPPicName(String UserPPicName) {
        this.UserPPicName = UserPPicName;
    }
    ...
    public void setCompanyRating(String comapnyRating){this.companyRating = comapnyRating;}
