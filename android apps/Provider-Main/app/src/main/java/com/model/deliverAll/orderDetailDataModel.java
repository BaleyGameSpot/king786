...
public class orderDetailDataModel implements Serializable {
    ...
    public void setDisplayDate(String tDisplayDate) {
        this.tDisplayDate = tDisplayDate;
    }
    ...
    public void setDisplayTime(String tDisplayTime) {
        this.tDisplayTime = tDisplayTime;
    }

    public String getDisplayDateTime() {
        return tDisplayDateTime;
    }

    public void setDisplayDateTime(String tDisplayDateTime) {
        this.tDisplayDateTime = tDisplayDateTime;
    }
}
