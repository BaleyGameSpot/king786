...
public class SetGeneralData {
    ...
    public SetGeneralData(GeneralFunctions generalFunc, JSONObject responseObj) {
        ...
        if (!generalFunc.getMemberId().equalsIgnoreCase("")) {
            ...
            storeData.put("RIDER_REQUEST_ACCEPT_TIME_BID_TAXI", generalFunc.getJsonValueStr("RIDER_REQUEST_ACCEPT_TIME_BID_TAXI", responseObj));
            ...
            storeData.put(Utils.DEFAULT_CURRENCY_VALUE, generalFunc.getJsonValue("vCurrencyDriver", generalFunc.retrieveValue(Utils.USER_PROFILE_JSON)));
