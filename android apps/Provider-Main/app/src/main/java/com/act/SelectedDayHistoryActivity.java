...
public class SelectedDayHistoryActivity extends ParentActivity {
        ...
        if (isDataAvail) {
            ...
            if (msgArr != null) {
                ...
                for (int i = 0; i < msgArr.length(); i++) {
                    ...
                    ((MTextView) customView.findViewById(R.id.timeTxt)).setText(generalFunc.getJsonValueStr("tDisplayDateTime",obj_temp));
    ...
    public void BuildType() {
        ...
        LayoutDirection.setLayoutDirection(list_type);
        list_type.show();
    }
