                                ...
                                for (int i = 0; i < arr_orders.length(); i++) {
                                    ...
                                    if (arr_date != null && arr_date.length() > 0) {
                                        for (int j = 0; j < arr_date.length(); j++) {
                                            ...
                                            //map.put("ConvertedOrderRequestDate", generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(tOrderRequestDate, Utils.OriginalDateFormate, DateTimeUtils.DateFormat)));
                                            //map.put("ConvertedOrderRequestTime", generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(tOrderRequestDate, Utils.OriginalDateFormate, DateTimeUtils.OriginalTimeFormat)));
