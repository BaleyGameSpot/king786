...
public class AdditionalChargeActivity extends ParentActivity implements RecurringTask.OnTaskRunCalled {
    ...
    private MaterialEditText timatrialfeeVTxt, miscfeeVTxt, discountVTxt;
    private MaterialEditText tollfeeVTxt, otherfeeVTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (data.containsKey("vChargesDetailDataAvailable") && data.get("vChargesDetailDataAvailable").equalsIgnoreCase("Yes")) {
            ...
            if (isUFX) {
                ...
                miscfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("" + miscfee, false));
                timatrialfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("" + matrialfee, false));
                discountVTxt.setText(AutoFitEditText.convertCommaToDecimal("" + discount, false));
            } else {
                ...
                additonallist.remove(2);
                additonallist.add(2, discount);
                tollfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("" + tollAmount, false));
                otherfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("" + otherChargeAmount, false));
                discountVTxt.setText(AutoFitEditText.convertCommaToDecimal("" + discount, false));
            }
    ...
    public void initViews() {
        ...
        if (getIntent().getExtras().getString("eType") != null && Utils.checkText(getIntent().getExtras().getString("eType"))) {
        ...
        resendSecInMilliseconds = resendSecAfter * 1000;
        ...
        timatrialfeeVTxt.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(2)});
        miscfeeVTxt.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(2)});
        discountVTxt.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(2)});
        tollfeeVTxt.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(2)});
        otherfeeVTxt.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(2)});
        ...
        String data = AutoFitEditText.convertCommaToDecimal("0.00", false);
        ...
        timatrialfeeVTxt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (val.startsWith(".") || val.equals(".")) {
                    timatrialfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("0.", false));
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length() > 0) {
                    matrialfee = 0.00;
                    try {
                        matrialfee = GeneralFunctions.parseDoubleValue(0.00, AutoFitEditText.convertCommaToDecimal(s.toString(), true));
                        additonallist.remove(0);
                        additonallist.add(0, matrialfee);
        ...
        miscfeeVTxt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (val.startsWith(".") || val.equals(".")) {
                    miscfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("0.", false));
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0) {
                    miscfee = 0.00;
                    try {
                        miscfee = GeneralFunctions.parseDoubleValue(0.00, AutoFitEditText.convertCommaToDecimal(s.toString(), true));
                        additonallist.remove(1);
                        additonallist.add(1, miscfee);
                        calculateData(s.toString(), finalvalTxt);
                    } catch (Exception e) {
        ...
        otherfeeVTxt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (val.startsWith(".") || val.equals(".")) {
                    otherfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("0.", false));
                ...
                double discountValue = GeneralFunctions.parseDoubleValue(0.0, AutoFitEditText.convertCommaToDecimal(s.toString(), true));
        ...
        tollfeeVTxt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (val.startsWith(".") || val.equals(".")) {
                    tollfeeVTxt.setText(AutoFitEditText.convertCommaToDecimal("0.", false));
        ...
        discountVTxt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (val.startsWith(".") || val.equals(".")) {
                    discountVTxt.setText(AutoFitEditText.convertCommaToDecimal("0.", false));
    ...
    public void onClick(View view) {
        ...
        if (i == skipBtn.getId()) {
            ...
            if (additonallist.get(0).equals(0.0) &&
                ...
                alertBox.setPositiveBtn(generalFunc.retrieveLangLBl("Submit", "LBL_BTN_YES_TXT"));
                alertBox.setNegativeBtn(generalFunc.retrieveLangLBl("Cancel", "LBL_BTN_NO_TXT"));
    ...
    public void openVerificationDialog() {
        ...
        LayoutDirection.setLayoutDirection(dialog_verify);
        dialog_verify.show();
    }
