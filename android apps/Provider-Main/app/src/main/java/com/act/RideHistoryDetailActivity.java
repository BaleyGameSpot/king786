...
public class RideHistoryDetailActivity extends ParentActivity implements OnMapReadyCallback {
    ...
    MTextView titleTxt;
    private MTextView subTitleTxt, interCityDestAddressHTxt, interCityDestAddressTxt, intercityPickupDt, intercityReachedDt, intercityEndDt, sourceAddressTxt, tripdateVTxt;
    private ImageView backImgView, interCityImagedest, imagedest, imagemarkerdest2;
    ...
    LinearLayout beforeServiceArea, afterServiceArea, interCityDestArea, dropToLocation;
    ...
    private DividerView dashImageInterCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagemarkerdest2 = findViewById(R.id.imagemarkerdest2);
        dashImageInterCity = findViewById(R.id.dashImageInterCity);
...
//                                    map.put("LBL_BOOKING_NO", generalFunc.retrieveLangLBl("Delivery No", "LBL_DELIVERY_NO"));
    ...
    public void setData(String tripData) {
        ...
        ((MTextView) findViewById(R.id.namePassengerVTxt)).setText(generalFunc.getJsonValue("vName", tripData) + " " + generalFunc.getJsonValue("vLastName", tripData) + " (" + driverhVal + ")");
        //tripdateVTxt.setText(generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(generalFunc.getJsonValue("tTripRequestDateOrig", tripData), Utils.OriginalDateFormate, DateTimeUtils.getDetailDateFormat(generalFunc))));
        tripdateVTxt.setText(generalFunc.getJsonValue("tTripRequestDisplayDateTime", tripData));
        ...
        if (Utils.checkText(generalFunc.getJsonValue("eIsInterCity", tripData)) && generalFunc.getJsonValue("eIsInterCity", tripData).equalsIgnoreCase("yes") &&
            ...
            ((MTextView) findViewById(R.id.dropOffVTxt)).setText(generalFunc.getJsonValue("tDropAddress", tripData));
            interCityDestAddressTxt.setText(generalFunc.getJsonValue("tReturnAddress", tripData));

            tripdateVTxt.setVisibility(View.GONE);
            intercityPickupDt.setText(generalFunc.getJsonValue("FormattedTripDate", tripData));
            intercityReachedDt.setText(generalFunc.getJsonValue("tReachedDateTimeFormatted", tripData));
            intercityEndDt.setText(generalFunc.getJsonValue("tEndDateFormatted", tripData));
            ...
            dashImageInterCity.setVisibility(View.VISIBLE);
        }
        ...
        if (generalFunc.getJsonValue("eType", tripData).equalsIgnoreCase("UberX") || generalFunc.getJsonValue("eFareType", tripData).equalsIgnoreCase("Fixed")) {
            ...
            ((MTextView) findViewById(R.id.pickUpVTxt)).setText(generalFunc.getJsonValue("tSaddress", tripData));
            interCityDestAddressHTxt.setText(generalFunc.getJsonValue("tSaddress", tripData));
            ((MTextView) findViewById(R.id.pickUpAddressVTxt)).setText(generalFunc.getJsonValue("tSaddress", tripData));
        ...
        if (FareDetailsArrNewObj != null) addFareDetailLayout(FareDetailsArrNewObj);
            ...
            if (responseStringObject != null) {
                ...
                if (GeneralFunctions.checkDataAvail(Utils.action_str, responseStringObject)) {
                    ...
                    if (Utils.checkText(msg_str)) {
                        ...
                        generalFunc.showGeneralMessage(generalFunc.retrieveLangLBl("Error", "LBL_ERROR_TXT"), generalFunc.retrieveLangLBl("", msg_str));
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.viewReqServicesTxtView) {
        ...
        } else if (id == R.id.subTitleTxt) {
            sendReceipt();
        } else if (id == R.id.signArea) {
