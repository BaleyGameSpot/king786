...
require_once('assets/libraries/syslibs/vendor/autoload.php');
...
class timthumb {
    ...
    protected function processImageAndWriteToCache($localImage) {
        ...
        $origType = isset($sData[2]) ? $sData[2] : '';
        $mimeType = isset($sData['mime']) ? $sData['mime'] : '';
        ...
        $new_width = round((int) abs($this->param('w', 0)));
        $new_height = round((int) abs($this->param('h', 0)));
