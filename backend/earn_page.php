...
<div class="common-inner-heading-section">
    <div class="common-inner-heading-section-inner">
        <h2 class="common-inner-heading"><?= $langage_lbl['LBL_FOOTER_LINK_EARN'] ?></h2>
    </div>
</div>
    ...
    <div class="banner-section-inner">
        <div class="banner-back">
            <div class="banner-image" id="1" style="display: block;">
                <div class="banner-image servicePage1 shine">
                    <img class = "imageVisibilityHidden resizeImageWithJs " attr-image-src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$banner_section['img_'.$vCode]; ?>" alt="<?php echo $banner_section['img_alt_'.$vCode];?>">
                </div>
            </div>
        </div>
        ...
        <div class="get_app_content">
            ...
            <?php if (!empty($IPHONE_APP_LINK_EARN_PAGE)) { ?>
                <div class="store_image">
                    <a href="<?= $IPHONE_APP_LINK_EARN_PAGE?>" target="_blank"><img src="assets/img/ios-store.svg" alt="" ></a>
                </div>
            <?php } ?>
            <?php if (!empty($ANDROID_APP_LINK_EARN_PAGE)) { ?>
                <div class="store_image">
                    <a href="<?= $ANDROID_APP_LINK_EARN_PAGE ?>" target="_blank"><img src="assets/img/google-play.svg" alt=""></a>
                </div>
            <?php } ?>
        </div>
    </div>
