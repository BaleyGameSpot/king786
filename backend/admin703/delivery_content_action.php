...
if (!empty($img_arr)) {
    ...
    foreach ($img_arr as $key => $value) {
        if (!empty($value['name'])) { 
            ...
            if($key=='calculate_section_img') $key = 'lCalculateSection';
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | Parcel Delivery Home Content <?= $action; ?></title>
            ...
            <div id="content">
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-8" >
                                <h2><?= $action; ?> Parcel Delivery Home Content</h2>
                            </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               ...
                                               <br/>
                                                <span class="notes">[Note: For Better Resolution Upload only image size of 860px * 442px. <br> <?= IMAGE_INSTRUCTION_NOTES ?> ]</span>
                                           </div>
                                       </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row ">
                                            <div class="col-lg-12 download-section-header">
                                                ...
                                                <p>Note: The content editing provided below will reflect in "Download" section of all inner pages. <br> <?= IMAGE_INSTRUCTION_NOTES ?> </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
