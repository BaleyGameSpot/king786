...
if (!empty($img_arr)) {
    ...
    foreach ($img_arr as $key => $value) {
        if (!empty($value['name'])) {
            ...
            if (ENABLE_DYNAMIC_CREATE_PAGE == "Yes") {
                $img_str = 'img_';
                if ($key == 'how_it_work_section_img') $key = 'lHowitworkSection';  else if ($key == 'benefit_section_img') $key = 'lBenefitSection';else if ($key == 'banner_section_img') $key = 'lBannerSection';
            } else {
                $img_str = 'img_';
                if ($key == 'how_it_work_section_img') $key = 'lHowitworkSection';  else if ($key == 'benefit_section_img') $key = 'lBenefitSection';else if ($key == 'banner_section_img') $key = 'lBannerSection';
            }
...
if (isset($_POST['submit'])) {
    ...
    $how_it_work_section_arr['img_alt_'.$vCode] = isset($_POST['how_it_work_section_img_alt']) ? $_POST['how_it_work_section_img_alt'] : '';
...
<head>
    <meta charset="UTF-8"/>
    <title>Admin | Car Pool Home Content <?= $action; ?></title>
    ...
    <div id="content">
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-8" >
                        <h2><?= $action; ?> Car Pool Home Content</h2>
                    </div>
