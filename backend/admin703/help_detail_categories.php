...
if ($sortby == 1) {
    if ($order == 0) $ord = " ORDER BY vImage ASC"; else
                ...
                <div class="row">
				    ...
				    action="<?php echo $_SERVER['PHP_SELF'] ?>">
						    ...
						    onClick="Redirect(3,<?php if ($sortby == '3') {
                                                    echo $order;
                                                } else { ?>0<?php } ?>)">Display Order <?php if ($sortby == 3) {
                                                    if ($order == 0) { ?>
						    <i class="fa fa-sort-amount-asc" 
						    aria-hidden="true"></i> <?php } else { ?>
						    <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                                        ...
                                                        <div class="social show-moreOptions openPops_<?= $data_drv[$i]['iHelpDetailCategoryId']; ?>">
                                                            <ul>
                                                                ...
                                                                <li class="entypo-twitter" data-network="twitter">
                                                                    <a href="help_detail_categories_action.php?id=<?= $iUniqueId; ?>"
                                                                       data-toggle="tooltip" title="Edit">
                                                                        <img src="img/edit-icon.png" alt="Edit">
                                                                    </a>
                                                                </li>
                                                                <?php } ?>
                                                                <?php //if (isset($data_drv[$i]['eDefault']) && $data_drv[$i]['eDefault'] != 'Yes') { ?>
                                                                    <?php if ($userObj->hasPermission('update-status-help-detail-category')) { ?>
                                                                        <li class="entypo-facebook"
                                                                            data-network="facebook">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?= $iUniqueId; ?>', 'Inactive')"
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatus('<?= $iUniqueId; ?>', 'Active')"
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('delete-help-detail-category')) { ?>
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);"
                                                                               onclick="changeStatusDelete('<?= $iUniqueId; ?>')"
