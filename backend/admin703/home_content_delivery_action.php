                                        ...
                                        <div style="display: none;">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-lg-6">
                                                   ...
                                                   <input type="text" class="form-control" name="service_section_main_title"  id="service_section_main_title" value="<?= $service_section['main_title_'.$vCode]; ?>" placeholder="Main Title">
                                                    ...
                                                    <div class="col-lg-11">
                                                         ...
                                                         <? if ($benefit_section['img_sec_'.$vCode] != '') { ?>
                                                            ...
                                                            <!-- <img src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$benefit_section['img_sec_'.$vCode]; ?>" class="innerbg_image"/> -->
                                                             ...
                                                             <img src="<?= $tconfig["tsite_url"].'resizeImg.php?h=300&src='.$tconfig["tsite_upload_apptype_page_images"].$template.'/'.$benefit_section['img_sec_'.$vCode]; ?>" class="innerbg_image whiteimgbg"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                               ...
                                               <input type="text" class="form-control" name="secure_section_main_title"  id="secure_section_main_title" value="<?= $secure_section['main_title_'.$vCode]; ?>" placeholder="Main Title">
