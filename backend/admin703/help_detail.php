...
if ($sortby == 1) {
    if ($order == 0) $ord = " ORDER BY f.vTitle_" . $default_lang . " ASC"; else
        $ord = " ORDER BY f.vTitle_" . $default_lang . " DESC";
}
if ($sortby == 2) {
    if ($order == 0) $ord = " ORDER BY fc.vTitle ASC"; else
...
//Pagination End
if ($keyword != '') {
    $sql = "SELECT f.iHelpDetailId,f.iHelpDetailCategoryId,f.iDisplayOrder,f.eStatus,f.vTitle_" . $default_lang . ", fc.vTitle AS cat_name FROM " . $tbl_name . " f, help_detail_categories fc WHERE f.iHelpDetailCategoryId = fc.iUniqueId AND fc.vCode = '" . $default_lang . "' $ssql $ord";
} else {
            ...
            <div class="table-list">
                <div class="row">
				    ...
				    action="<?php echo $_SERVER['PHP_SELF'] ?>">
						...
						<input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $data_drv[$i]['iHelpDetailId']; ?>" />&nbsp;
						 </td>                                                  
                                                                ...
                                                                <ul>
                                                                    <?php if ($userObj->hasPermission('edit-help-detail')) { ?>
                                                                        <li class="entypo-twitter" data-network="twitter">
                                                                            <a href="help_detail_action.php?id=<?= $data_drv[$i]['iHelpDetailId']; ?>&help_detail_cat_id=<?= $iHelpDetailCategoryId; ?>"
