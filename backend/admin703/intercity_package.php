<?php
    ...
    include_once('intercity_package_v2.php');
    exit;
    ...
    if (isset($_POST['btnsubmitnew'])) {    
            ...
            if(SITE_TYPE =='Demo') {
              $_SESSION['success'] = 2;
              header("Location:intercity_package.php?id=".$id);exit;
            }
...
<html lang="en" class="ie8">
    ...
    <html lang="en" class="ie9">
        ...
        <html lang="en">
            ...
            <head>
                <meta charset="UTF-8" />
                <title><?=$SITE_NAME;?> | InterCity Packages </title>
            ...
            <body class="padTop53">
                ...
                <div id="content">
                    <div class="inner">
                        <div id="add-hide-show-div">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h2><?php echo ucfirst_multibyte($data_main[0]['vVehicleType']);?> InterCity Packages</h2>
                                </div>
                            </div>
                            <hr />
                        </div>
                        ...
                        <form name="frmsearch" id="frmsearch" action="javascript:void(0);" method="post">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                                <tbody>
                                    <tr>
                                        <td width="30%"><a href="intercity_vehicle_list.php" class="back_link">
                                            <input type="button" value="Back to Listing" class="add-btn">
                                            <?php if($userObj->hasPermission('create-rental-intercity-packages')){ ?>
                        ...
                        <div class="admin-nir-export">
                            <div class="changeStatus col-lg-12 option-box-left">
                                <span class="col-lg-2 new-select001">
                                    <?php if($userObj->hasPermission('delete-rental-intercity-packages')){ ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="15%"><a href="javascript:void(0);" onClick="Redirect(2,<?php if($sortby == '2'){ echo $order; }else { ?>0<?php } ?>)">Package Total Price(In <?=$db_currency[0]['vName']?>) <?php if ($sortby == 2) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        <th width="15%"><a href="javascript:void(0);" onClick="Redirect(3,<?php if($sortby == '3'){ echo $order; }else { ?>0<?php } ?>)">Package <em class="change_eUnit" style="font-style: normal"><?=$DEFAULT_DISTANCE_UNIT;?><?php if ($sortby == 3) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                                        <th width="15%"><a href="javascript:void(0);" onClick="Redirect(4,<?php if($sortby == '4'){ echo $order; }else { ?>0<?php } ?>)">Package Hour<?php if ($sortby == 4) { if($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php } }else { ?>  <i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>
                                    ...
                                    <div class="admin-notes" style="display:none;">
                                        <h4>Notes:</h4>
                                        <ul>
                                            <li>Commision for the taxi InterCity will be the commission for the vehicle type </li>
                                            ...
                                            <li>If the "Enable Surge charge on InterCity" option is enabled from the settings then surge prices are applied to the taxi InterCity trips.</li>
                                            ...
                                            <div>
                                                <div class="body-div">
                                                    ...
                                                    <div class="form-group">
                                                        <form id="rental_package" name="rental_package" method="post" action="intercity_package.php?id=<?php echo $id;?>" enctype="multipart/form-data" >
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <label>Package Total Price  (In <?=$db_currency[0]['vName']?>) <span class="red"> *</span></label>
                                                                </div>
                                                                <div class="col-lg-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <label>Package <em class="change_eUnit" style="font-style: normal"><?=$DEFAULT_DISTANCE_UNIT;?></em><span class="red"> *</span></label>
                                                                </div>
                                                                <div class="col-lg-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <label>Package Hour<span class="red"> *</span></label>
                                                                </div>
                                                                <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <?php if($userObj->hasPermission(['create-rental-intercity-packages', 'edit-rental-intercity-packages'])){ ?>
                                                                <input type="submit" class="btn btn-default" name="btnsubmitnew" id="btnsubmit"  value="Add InterCity Package" >
                                                                <?php  } ?>
                                                            </div>
                                                        </form>
                                                    </div>
                ...
                <!--END MAIN WRAPPER -->
                <form name="pageForm" id="pageForm" action="action/intercity_package.php" method="post" >
                ...
                <script>
                    ...
                    $('#btnsubmit').val("Add InterCity Package");
