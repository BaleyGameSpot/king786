...
if (!empty($img_arr)) {
    ...
    foreach ($img_arr as $key => $value) {
        if (!empty($value['name'])) {
            ...
            $img_str = 'img_';
            if ($key == 'how_it_work_section_img') $key = 'lHowitworkSection'; else if ($key == 'calculate_section_img') $key = 'lCalculateSection'; else if ($key == 'banner_section_img') $key = 'lBannerSection';
    ...
    <div id="content">
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-8" >
                        <h2><?= $action; ?> Taxi Home Content</h2>
                    </div>
            ...
            <div class="body-div">
                <div class="form-group">
                    ...
                    <form method="post" name="_home_content_form" id="_home_content_form" action=""
                        ...
                        <?php  if (ONLY_MEDICAL_SERVICE == "No" && $iVehicleCategoryId == '174') {
                                    ...
                                    <!-- <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="calculate_section_menu_title"
                                                   ...
                                                   value="<?= $calculate_section['menu_title_' . $vCode]; ?>"
                                                   placeholder="Menu Title">
                                        </div>
                                    </div> -->
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="calculate_section_title"
                                                   ...
                                                   value="<?= $calculate_section['title_' . $vCode]; ?>"
                                                   placeholder="Title" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea class="form-control ckeditor" rows="10"
                                                      ...
                                                      placeholder="Description"><?= $calculate_section['desc_' . $vCode]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <? if ($calculate_section['img_' . $vCode] != '') { ?>
                                                <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $calculate_section['img_' . $vCode]; ?>"
                                                     class="innerbg_image"/>
                                            <? } ?>
