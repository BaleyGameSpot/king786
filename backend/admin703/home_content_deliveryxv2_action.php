        ...
        foreach ($img_arr as $key => $value) {
            ...
            if ($key == 'safe_section_img_first' || $key == 'safe_section_img_sec' || $key == 'safe_section_img_third' || $key == 'safe_section_img_four' || $key == 'register_section_img_first'  || $key == 'register_section_img_sec') {
                ...
                if (!empty($value['name'])) {
                    ...
                    else if ($key == 'safe_section_img_first' || $key == 'safe_section_img_sec' || $key == 'safe_section_img_third' || $key == 'safe_section_img_four') $key = 'lSecuresafeSection';
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="header_first_label" id="header_first_label" value="<?= $header_first_label; ?>" placeholder="Home First Section Title" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="third_sec_desc" id="third_sec_desc" placeholder="Home First Section Description" ><?= $third_sec_desc; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="third_mid_title_two" id="third_mid_title_two" value="<?= $third_mid_title_two; ?>" placeholder="Home Forth Section First Text" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="third_mid_desc_one" id="third_mid_desc_one" placeholder=">Home First Section Second Button Description" ><?= $third_mid_desc_one; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="third_mid_title_one1" id="third_mid_title_one1" value="<?= $third_mid_title_one1; ?>" placeholder="Home Fifth Section Title" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea class="form-control ckeditor" rows="10" name="taxi_app_right_desc" id="taxi_app_right_desc" placeholder="Home Fifth Section Description" ><?= $taxi_app_right_desc; ?></textarea>
