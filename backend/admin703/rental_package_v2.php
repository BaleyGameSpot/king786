                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            ...
                            <a href="rental_vehicle_list.php" class="back_link">
                                        ...
                                        for ($i = 0;$i < scount($data_drv);$i++){
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td style="text-align:center;">
                                                    ...
                                                    <input type="checkbox" id="checkbox" name="checkbox[]" <?php echo isset($default) ? $default : ''; ?> value="<?php echo $data_drv[$i]['iRentalPackageId']; ?>"/>&nbsp;
                                                ...
                                                <td align="center" style="text-align:center;" class="action-btn001">
                                                    ...
                                                    <div class="share-button openHoverAction-class"
                                                        ...
                                                        <div class="social show-moreOptions for-five openPops_<?= isset($data_drv[$i]['iUserId']) ? $data_drv[$i]['iUserId'] : '';?>">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <?php if ($userObj->hasPermission('edit-users')){ ?>
                                                                    ...
                                                                    <li class="entypo-twitter"
                                                                        ...
                                                                        <a href="rental_package_action.php?iVehicleTypeId=<?=$data_drv[$i]['iVehicleTypeId'];?>&iRentalPackageId=<?=$data_drv[$i]['iRentalPackageId'];?>"
