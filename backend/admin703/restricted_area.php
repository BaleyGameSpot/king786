...
if ($sortby == 5) {
    if ($order == 0) $ord = " ORDER BY ra.eRestrictType ASC"; else
        $ord = " ORDER BY ra.eRestrictType DESC";
}
if ($sortby == 6) {
    if ($order == 0) $ord = " ORDER BY ra.eStatus ASC"; else
        $ord = " ORDER BY ra.eStatus DESC";
}
if ($sortby == 7) {
    if ($order == 0) $ord = " ORDER BY ra.eType ASC"; else
                    ...
                    <tr>
                        ...
                        <td width="10%" class=" padding-right10">
                            <select name="option" id="option" class="form-control">
                                ...
                                <option value="lm.vLocationName" <?php if ($option == 'lm.vLocationName') {
                                    echo "selected";
                                } ?> >Address
                                </option>
                            </select>
                                        ...
                                        <th>
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(4,<?php if ($sortby == '4') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Address <?php if ($sortby == 4) {
                                                    if ($order == 0) { ?>
                                            ...
                                            <th width="15%">
                                                <a href="javascript:void(0);"
                                                   onClick="Redirect(5,<?php if ($sortby == '5') {
                                                       echo $order;
                                                   } else { ?>0<?php } ?>)">Area <?php if ($sortby == 5) {
                                                        if ($order == 0) { ?>
                                                            <i class="fa fa-sort-amount-asc"
                                                               aria-hidden="true"></i> <?php } else { ?>
                                        ...
                                        <th width="15%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(7,<?php if ($sortby == '7') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Type <?php if ($sortby == 7) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        <th width="6%" class='align-center'>
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(6,<?php if ($sortby == '6') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Status <?php if ($sortby == 6) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        ...
                                        for ($i = 0; $i < $count_all; $i++) {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td width="20%" align="center" class="center">
                                                    ...
                                                    <img src="<?= $dis_img; ?>" alt="<?= $db_data[$i]['eStatus']; ?>"
                                                         data-toggle="tooltip" title="<?= $db_data[$i]['eStatus']; ?>">
                                                </td>
                                                <?php if ($userObj->hasPermission(['edit-restricted-area', 'update-status-restricted-area', 'delete-restricted-area'])) { ?>
                                                                ...
                                                                <ul>
                                                                    <?php if ($userObj->hasPermission('edit-restricted-area')) { ?>
                                                                        <li class="entypo-twitter"
                                                                            ...
                                                                            <a href="restricted_area_action.php?restricted_id=<?= $db_data[$i]['iRestrictedNegativeId']; ?>"
