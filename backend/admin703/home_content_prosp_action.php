...
if (isset($_POST['submit'])) {
    ...
    $call_section_arr['title2'] = isset($_POST['call_section_title_2']) ? $_POST['call_section_title_2'] : '';
    $call_section_arr['desc2'] = isset($_POST['call_section_desc_2']) ? $_POST['call_section_desc_2'] : '';
    $call_section_arr['img2_' . $vCode] = isset($sectionData['img2_' . $vCode]) ? $sectionData['img2_' . $vCode] : '';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="lServiceSection_title"
                                               id="lServiceSection_title" value="<?= $lServiceSection['title']; ?>"
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="lServiceSection_subtitle"
                                               ...
                                               value="<?= $lServiceSection['subtitle']; ?>"
                        ...
                        <div class="body-div innersection">
                            <div class="form-group general_section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="call_section_title_2" id="call_section_title_2" value="<?= $call_section['title2']; ?>" placeholder="Title">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="5" name="call_section_desc_2" id="call_section_desc_2" placeholder="Description"><?= $call_section['desc2']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <? if ($call_section['img2_' . $vCode] != '') { ?>
                                            <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $call_section['img2_' . $vCode]; ?>" class="innerbg_image"/>
                                        <? } ?>
