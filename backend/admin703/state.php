...
if ($sortby == 2) {
    if ($order == 0) $ord = " ORDER BY s.vState ASC"; else
        $ord = " ORDER BY s.vState DESC";
}
if ($sortby == 3) {
    if ($order == 0) $ord = " ORDER BY s.vStateCode ASC"; else
        $ord = " ORDER BY s.vStateCode DESC";
}
if ($sortby == 4) {
    if ($order == 0) $ord = " ORDER BY s.eStatus ASC"; else
					...
					<a href="javascript:void(0);" onClick="Redirect(2,<?php
						...
						<i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a>
                                        ...
                                        <?php } ?>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <?php } ?>
                                                            ...
                                                            <td align="center"><?= $data_drv[$i]['vStateCode']; ?></td>
								...
								<span><img src="images/settings-icon.png" alt=""></span>
									    ...
									    <a href="state_action.php?id=<?= $data_drv[$i]['iStateId']; ?>" 
									    data-toggle="tooltip" title="Edit">
                                                                    ...
                                                                    <?php if ($userObj->hasPermission('update-status-state')) { ?>
                                                                        ...
                                                                        <li class="entypo-gplus" data-network="gplus">
                                                                            <a href="javascript:void(0);" onclick="changeStatus('<?php echo $data_drv[$i]['iStateId']; ?>', 'Active')"
                                                                                data-toggle="tooltip"
                                                                                title="Deactivate">
