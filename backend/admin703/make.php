...
if ($sortby == 1) {
    if ($order == 0) $ord = " ORDER BY vMake ASC"; else
                                        ...
                                        for ($i = 0; $i < scount($data_drv); $i++) { ?>
                                            <tr class="gradeA">
                                                ...
                                                <td align="center" style="text-align:center;">
                                                    ...
                                                    } else if (isset($data_drv[$i]['eStatus']) && $data_drv[$i]['eStatus'] == 'Inactive') {
                                                        $dis_img = "img/inactive-icon.png";
                                                    } else if (isset($data_drv[$i]['eStatus']) && $data_drv[$i]['eStatus'] == 'Deleted') {
                                                            ...
                                                            <ul>
                                                                <?php if ($userObj->hasPermission('edit-vehicle-make')) { ?>
                                                                    <li class="entypo-twitter" data-network="twitter">
                                                                        <a href="make_action.php?id=<?= $data_drv[$i]['iMakeId']; ?>"
