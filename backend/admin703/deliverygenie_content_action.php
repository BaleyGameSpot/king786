...
if (!empty($img_arr)) {
    ...
    foreach ($img_arr as $key => $value) {
        if (!empty($value['name'])) {
            ...
            $img_str = 'img_';
            if ($key == 'banner_section_img') $key = 'lBannerSection'; else if ($key == 'benefit_section_img') $key = 'lBenefitSection';
...
if (isset($_POST['submit'])) {
    ...
    $benefit_section_arr['img_alt_'.$vCode] = isset($_POST['benefit_section_img_alt']) ? $_POST['benefit_section_img_alt'] : '';
...
<head>
    <meta charset="UTF-8"/>
    <title>Admin | Delivery Genie/Runner Home Content <?= $action; ?></title>
        ...
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-8" >
                        <h2><?= $action; ?> Delivery Genie/Runner Home Content</h2>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <br/>
                                        <span class="notes"><b><?php echo constVal("IMAGE_RATIO_INSTRUCTION_NOTES"); ?></b></span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span class="notes">[Note: For Better Resolution Upload only image size of 270px * 480px. <br> <?= IMAGE_INSTRUCTION_NOTES ?> ]</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="benefit_section_img_alt" id="benefit_section_img_alt" value="<?= $benefit_section['img_alt_'.$vCode]; ?>" placeholder="Background Image alt Text">
                                    </div>
                                </div>
                            </div>
                        </div>
