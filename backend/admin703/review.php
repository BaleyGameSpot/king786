...
$reload1 = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '';
if(isset($reload1)){
    $urlparts = explode('?', $reload1);
    $parameters = isset($urlparts[1]) ? $urlparts[1] : '';
}
if (isset($_POST['btnsubmitnew'])) {
    ...
    if(isset($vMessage) && !empty($vMessage)) {
        $q = "INSERT INTO ";
        $where = '';
        if ($iRatingId != '') {
            $q = "UPDATE ";
        ...
        $obj->sql_query($query);
        $_SESSION['success'] = '1';
        $_SESSION['var_msg'] = 'Comment upadted.';
    } else {
        $_SESSION['success'] = '3';
        $_SESSION['var_msg'] = 'The comment contains only spaces or is empty.';
    }
    if (!empty($parameters)) {
...
<head>
    <meta charset="UTF-8"/>
    <title><?= $SITE_NAME ?> | <?php echo $langage_lbl_admin['LBL_TRIPS_TXT_ADMIN']. " Reviews";?></title>
    ...
    <div id="content">
        <div class="inner">
            <div id="add-hide-show-div">
                <div class="row">
                    <div class="col-lg-12">
                        <h2><?php echo $langage_lbl_admin['LBL_TRIPS_TXT_ADMIN']. " Reviews";?></h2>
                                ...
                                <select name="option" id="option"
                                    ...
                                    ?> >
                                        ...
                                        if ($APP_TYPE == 'UberX') {
                                            ...
                                            echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN'].' Name';
                                        }
                                        ?>
                                    </option>
                                            ...
                                            <table class="table table-striped table-bordered table-hover"
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($userObj->hasPermission(['delete-reviews',
                                                                                       'edit-review']) && $eStatus != 'Deleted' && SITE_TYPE == 'Live') { ?>
