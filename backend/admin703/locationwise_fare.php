...
if ($sortby == 2) {
    if ($order == 0) $ord = " ORDER BY lm2.vLocationName ASC"; else
        $ord = " ORDER BY lm2.vLocationName DESC";
}
if ($sortby == 3) {
    if ($order == 0) $ord = " ORDER BY ls.fFlatfare ASC"; else
                        ...
                        <div class="table-responsive">
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(2,<?php if ($sortby == '2') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Source Location Name<?php if ($sortby == 2) {
                                                    if ($order == 0) { ?>
                                        ...
                                        <th width="20%">
                                            <a href="javascript:void(0);"
                                               onClick="Redirect(3,<?php if ($sortby == '3') {
                                                   echo $order;
                                               } else { ?>0<?php } ?>)">Flat Fare<?php if ($sortby == 3) {
                                                    if ($order == 0) { ?>
                                                        <i class="fa fa-sort-amount-asc"
                                                           aria-hidden="true"></i> <?php } else { ?>
                                                        <i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
						  ...
						  value="<?php echo $data_drv[$i]['iLocatioId']; ?>" />&nbsp;
                                                ...
                                                <?php } ?>
                                                  ...
                                                  <td align="center"><?= formateNumAsPerCurrency($data_drv[$i]['fFlatfare'],''); ?></td>
                                                  <td align="center"><?= $data_drv[$i]['vVehicleType']; ?></td>
                                                  <td align="center" style="text-align:center;">
						      ...
						      <span><img src="images/settings-icon.png" alt=""></span>
									...
									<a href="location_wise_fare_action.php?id=<?= $data_drv[$i]['iLocatioId']; ?>" 
