...
<head>
    <meta charset="UTF-8"/>
    <title>Admin | On Demand Services Home Content <?= $action; ?></title>
    ...
    <div id="content">
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-8" >
                        <h2><?= $action; ?> On Demand Services Home Content</h2>
                    </div>
                        ...
                        <div class="body-div innersection seo_section">
                            <div class="form-group ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <textarea class="form-control" rows="10" name="tMetaDescription"  id="<?= $tMetaDescription; ?>"  placeholder="<?= $tMetaDescription; ?> Value"> <?= $tMetaDescription; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
