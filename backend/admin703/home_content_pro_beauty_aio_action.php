...
if (isset($_POST['removeicon']) && $_POST['removeicon'] == 'remove') {
    if (SITE_TYPE == 'Demo') {
        header("Location:home_content_pro_beauty_aio_action.php?id=" . $id . "&success=2");
        exit;
    }
    $_POST['removeicon'] = "";
...
if (isset($_POST['submit'])) {
    ...
    $how_it_work_section_arr['small_title'] = isset($_POST['how_it_work_section_small_title']) ? $_POST['how_it_work_section_small_title'] : '';
    ...
    $call_section_arr['subtitle1'] = isset($_POST['call_section_sub_title_1']) ? $_POST['call_section_sub_title_1'] : '';
    $call_section_arr['title1'] = isset($_POST['call_section_title_1']) ? $_POST['call_section_title_1'] : '';
    $call_section_arr['desc1'] = isset($_POST['call_section_desc_1']) ? $_POST['call_section_desc_1'] : '';
    $call_section_arr['img1_' . $vCode] = isset($sectionData['img1_' . $vCode]) ? $sectionData['img1_' . $vCode] : '';
    ...
    $lServiceSection_arr['title'] = isset($_POST['lServiceSection_title']) ? $_POST['lServiceSection_title'] : '';
    $lServiceSection_arr['small_title'] = isset($_POST['lServiceSection_small_title']) ? $_POST['lServiceSection_small_title'] : '';
    $lServiceSection_arr['subtitle'] = isset($_POST['lServiceSection_subtitle']) ? $_POST['lServiceSection_subtitle'] : '';
...
if (isset($_POST['catlogo'])) {
    ...
    if (isset($_FILES['vHomepageLogoOurServices']) && $_FILES['vHomepageLogoOurServices']['name'] != "") {
        ...
        if ($flag_error == 1) {
            $_SESSION['success'] = '';
            $_SESSION['var_msg'] = '';
            header("Location:home_content_pro_beauty_aio_action.php?id=" . $id . "&var_msg=" . $var_msg . "&goback=1");
            exit;
        }
    }
                        ...
                        <div class="body-div innersection">
                            <div class="form-group general_section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="call_section_sub_title_1" id="call_section_sub_title_1" value="<?= $call_section['subtitle1']; ?>" placeholder="Title">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="call_section_title_1" id="call_section_title_1" value="<?= $call_section['title1']; ?>" placeholder="Title">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control ckeditor" rows="5" name="call_section_desc_1" id="call_section_desc_1" placeholder="Description"><?= $call_section['desc1']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <? if ($call_section['img1_' . $vCode] != '') { ?>
                                            <img src="<?= $tconfig["tsite_url"] . 'resizeImg.php?h=300&src=' . $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $call_section['img1_' . $vCode]; ?>" class="innerbg_image"/>
                                        <? } ?>
                                ...
                                <div  class="form-group">
                                    <label>Note :  Click  <a target="_blank" href="category_content_page_uberx.php?id=<?= $iLanguageId; ?>">here</a> to manage services shown and its content.
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="body-div innersection">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="how_it_work_section_small_title"
                                               id="how_it_work_section_small_title" value="<?= $how_it_work_section['small_title']; ?>"
                                               placeholder="How It Section Small Title" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="register_section_desc_first"
                                               ...
                                               value="<?= $register_section['desc_first']; ?>" placeholder="Description"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="register_section_desc_sec"
                                               ...
                                               value="<?= $register_section['desc_sec']; ?>" placeholder="Description"
                                               required>
                                    </div>
                                </div>
                                <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        //history.go(-1);
        window.location.href = "home_content_pro_beauty_aio_action.php?id=<?php echo $id ?>";
