    ...
    <div class="banner-section-inner">
        <div class="banner-back">
            <div class="banner-image servicePage1 shine " id="1">
                <img class = "imageVisibilityHidden resizeImageWithJs " attr-image-src="<?php  echo $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$banner_section['img_'.$vCode]; ?>" alt="" loading="lazy">
            </div>
        </div>
        ...
        <div class="safety-section-right">
            ...
            <form name="_fare_estimate_form" id="_fare_estimate_form" method="post" action="cx-fareestimate.php" class="gen-from">
                ...
                <div class="form-group pickup-location">
                    ...
                    <img src="<?= $siteUrl ?>assets/img/detect_loc.svg" class="detect-loc" onclick="fetchLocation()" title="<?= $langage_lbl['LBL_FETCH_LOCATION_HINT'] ?>" style="width: 36px; right: 16px; top: 6px" loading="lazy">
                </div>
        ...
        <div class="safety-section-left">
            <div class="safty-image-hold servicePage2 width-100 shine">
                <img class = "imageVisibilityHidden resizeImageWithJs"
                        attr-image-src="<?= $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$calculate_section['img_'.$vCode]; ?>" alt="" loading="lazy">
            </div>
        </div>
