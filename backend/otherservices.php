...
<section class="banner-section taxi-app bannermenu">
    <div class="banner-section-inner">
        <div class="banner-back">
            <div class="banner-image servicePage1 shine" id="1"><img class = "imageVisibilityHidden resizeImageWithJs " attr-image-src="<?php echo $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $banner_section['img_' . $vCode]; ?>" alt="<?php echo $banner_section['img_alt_'.$vCode];?>" loading="lazy"></div>
        </div>
