...
<section class="safety-section taxi-variant page-section" id="our-benefits">
    <div class="safety-section-inner">
        ...
        <div class="safety-section-left">
            <div class="safty-image-hold servicePage2 shine width-100 ">
                <img class = "imageVisibilityHidden resizeImageWithJs " attr-image-src="<?php  echo $tconfig["tsite_upload_apptype_page_images"].$template.'/'.$benefit_section['img_'.$vCode]; ?>"  alt="<?php echo $benefit_section['img_alt_'.$vCode];?>" loading="lazy">
            </div>
        </div>
